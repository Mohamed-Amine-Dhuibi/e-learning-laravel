...
<h2 style="margin-left: 20%;color:gainsboro;">{{ $user->name }}</h2>
      <p><img src="https://cdn2.vectorstock.com/i/1000x1000/54/41/young-and-elegant-woman-avatar-profile-vector-9685441.jpg" alt="Pineapple" style="width:130px;height:130px;margin-right:30px; margin-left:8%;">
      ...
      <form action="#">
        ...
        <div>
          <label class="desc" id="title1" for="Field1" style=" word-spacing: 20px;"  > Name&nbsp:&nbsp&nbsp&nbsp&nbsp</label>
          <div>
             {{ $user->name }}
          </div>
        </div>
        <div>
          <label class="desc" id="title1" for="Field1"style=" word-spacing: 20px;"> Last_Name&nbsp:&nbsp&nbsp&nbsp&nbsp</label>
          <div>
           Last name
          </div>
        </div>
          <div>
            <label class="desc" id="title1" for="Field1"style=" word-spacing: 20px;"> Birthday&nbsp:&nbsp&nbsp&nbsp&nbsp</label>
          <div>
            2000/04/07
        ...
        <div>
          <label class="desc" id="title1" for="Field1"style=" word-spacing: 20px;"> age&nbsp:&nbsp&nbsp&nbsp&nbsp</label>
          <div>
            23
          </div>
        </div>
        <div>
          <label class="desc" id="title1" for="Field1"style=" word-spacing: 20px;"> Phone number&nbsp:&nbsp&nbsp&nbsp&nbsp</label>
          <div>
            78451278
          </div>
        </div>
        <div>
          <label class="desc" id="title1" for="Field1"style=" word-spacing: 20px;">
        ...
        <div>
          <label class="desc" id="title1" for="Field1"style=" word-spacing: 20px;"> member Since&nbsp:&nbsp&nbsp&nbsp&nbsp</label>
          <div>
            2021/04/07
